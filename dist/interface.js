...
<p>-Matty</p>`,[{label:"Close",onClick:e=>{},triggerClose:!0}]));const o=document.getElementById("hireMeNav");function r(e,t,o,n){const s=context.createOscillator(),a=context.createOscillator(),i=context.createGain();s.type=n,a.type=n,i.gain.value=vol,s.connect(i),a.connect(i),i.connect(context.destination),s.frequency.value=e+1,a.frequency.value=e-2,i.gain.setValueAtTime(vol,t+o-.05),i.gain.linearRampToValueAtTime(0,t+o),s.start(t),a.start(t),s.stop(t+o),a.stop(t+o)}function l(){switch(directionV){case"north":directionV="south";break;case"south":directionV="north";break;default:return}}function d(){switch(directionH){case"east":directionH="west";break;case"west":directionH="east";break;default:return}}function n(e,t,o){console.log("showModal called, titleHtml = ");const n=document.createElement("div");n.classList.add("modal--"),n.innerHTML=`
    ...
    `,e.querySelector(".modal--close").addEventListener("click",()=>w());const t=document.createElement("button");t.setAttribute("type","button"),t.classList.add("modal--button"),t.textContent="Skip This",t.addEventListener("click",()=>w()),e.querySelector(".modal--bottom").appendChild(t);const o=document.createElement("button");o.setAttribute("type","button"),o.classList.add("modal--button"),o.textContent="Save",o.addEventListener("click",()=>{!function(e){console.log(`savePlayer:name = ${e}`);var t={id:CURRENT_PLAYER,name:e},t={method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)};fetch(PLAYERS_URL,t).then(e=>e.json()).then(function(e){console.log(`updateGame(): name = ${e}`);e={id:CURRENT_GAME,name:e},e={method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(e)};fetch(GAMES_URL,e).then(e=>e.json()).then(()=>document.location.reload()).catch(e=>console.log(`updateGame: ${e}`))}(e)).catch(e=>console.log(`savePlayer: ${e}`))}(nameField.value.toUpperCase())}),e.querySelector(".modal--bottom").appendChild(o),document.body.appendChild(e)}function m(t){for(let e=0;e<t.length;e++){var o=t[e].name,n=t[e].code,s=Math.round(t[e].segments*keyWidth),a=keyHeight,i=t[e].position*keyWidth,c=t[e].row*keyHeight,r=t[e].status;KEY_ARRAY.push({name:o,code:n,x:i,y:c,w:s,h:a,s:r})}}function a(t){for(let e=0;e<t.length;e++){var o=t[e];!function(e,t,o,n,s,a){ctx.beginPath(),ctx.rect(o,n,s,a),ctx.strokeStyle=colorKeyUpStroke,ctx.lineWidth=strokeThickness,ctx.stroke(),ctx.closePath(),ctx.fillStyle=colorKeyUpFill,ctx.fill(),ctx.closePath(),ctx.id=t,ctx.font=typeFont,ctx.fillStyle=colorKeyFontUp;e=e.toUpperCase();ctx.textAlign="center",ctx.fillText(e,o+s/2,n+a/2+4)}(o.name,o.code,o.x,o.y,o.w,o.h)}}function u(){ctx.clearRect(0,0,canvas.width,canvas.height),ctx.lineWidth=strokeThickness,ctx.strokeStyle=colorKeyUpStroke,ctx.strokeRect(0,0,canvas.width,canvas.height),a(KEY_ARRAY),function(t){for(let e=0;e<t.length;e++){var o=t[e];1==o.s&&function(e,t,o,n,s,a){ctx.beginPath(),ctx.rect(o,n,s,a),ctx.strokeStyle=colorKeyDownStroke,ctx.lineWidth=strokeThickness,ctx.stroke(),ctx.closePath(),ctx.fillStyle=colorKeyDownFill,ctx.fill(),ctx.closePath(),ctx.id=t,ctx.font=typeFont,ctx.fillStyle=colorKeyFontDown;e=e.toUpperCase();ctx.textAlign="center",ctx.fillText(e,o+s/2,n+a/2+4)}(o.name,o.code,o.x,o.y,o.w,o.h)}}(KEY_ARRAY),i(),c(),function(t){for(let e=0;e<t.length;e++){var o=t[e],n=Math.round(o.x),s=Math.round(o.x+o.w),a=Math.round(o.y),i=Math.round(o.y+o.h),c=ballRadius;1==o.s&&(y>a+c&&y<i-c&&x>n+c&&x<s-c&&(o.s,function(e,t,o,n,s,a){ctx.beginPath(),ctx.rect(o,n,s,a),ctx.strokeStyle=colorKeyDownStroke,ctx.lineWidth=strokeThickness,ctx.stroke(),ctx.closePath(),ctx.fillStyle=colorKeyGrayFill,ctx.fill(),ctx.closePath(),ctx.id=t,ctx.font=typeFont,ctx.fillStyle=colorKeyFontDown;e=e.toUpperCase();ctx.textAlign="center",ctx.fillText(e,o+s/2,n+a/2+4)}(o.name,o.code,o.x,o.y,o.w,o.h)),y>a-c&&y<i+c&&(x>n-c&&x<n+c&&"east"===directionH&&(dx=-dx,d(),p()),x>s-c&&x<s+c&&"west"===directionH&&(dx=-dx,d(),p())),x>n-c&&x<s+c&&(y>a-c&&y<a+c&&"south"===directionV&&(dy=-dy,l(),p()),y>i-c&&y<i+c&&"north"===directionV&&(dy=-dy,l(),p())))}}(KEY_ARRAY),ctx.beginPath(),ctx.arc(x,y,ballRadius,0,2*Math.PI),ctx.fillStyle=colorBallFill,ctx.fill(),ctx.closePath(),ctx.strokeStyle=colorBallStroke,ctx.stroke(),ctx.closePath(),lives<1&&h(),(x+dx>canvas.width-ballRadius||x+dx<ballRadius)&&h(),(y+dy>canvas.height-ballRadius||y+dy<ballRadius)&&h(),x+=dx,y+=dy}function i(){scoreText.innerText="Score: "+score}function c(){livesText.innerText="Lives: "+lives}function p(){!function(e){for(key of e)key.s=0}(KEY_ARRAY),r(scoreNote1,context.currentTime,.116,"square"),r(scoreNote2,context.currentTime+.116,.232,"square"),score+=scoreIncrement,scoreNote1+=10,scoreNote2+=10,dx*=1.3}function h(){lives--,r(82.407,context.currentTime,.116,"square"),r(77.782,context.currentTime+.116,.116,"square"),r(69.296,context.currentTime+.232,.232,"square"),(lives?function(){switch(scoreNote1=493.883,scoreNote2=659.255,x=canvas.width/2,y=canvas.height/2,ranNumX=Math.ceil(+Math.random())*(Math.round(Math.random())?1:-1),ranNumY=Math.ceil(+Math.random())*(Math.round(Math.random())?1:-1),ranNumX){case 1:directionH="east";break;case-1:directionH="west";break;default:return}switch(ranNumY){case 1:directionV="south";break;case-1:directionV="north";break;default:return}dx=speed*ranNumX,dy=speed*ranNumY}:function(){gameOn=!1,g(),r(207.652,context.currentTime,.116,"square"),r(174.614,context.currentTime+.116,.116,"square"),r(146.832,context.currentTime+.232,.232,"square"),clearInterval(interval),interval="";var e={id:CURRENT_GAME,score:score},e={method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(e)};fetch(GAMES_URL,e).then(e=>e.json()).then((console.log("saveOrNot()"),void(0<score?s():document.location.reload()))).catch(e=>console.log(`endGame: ${e}`))})()}function g(){!0===gameOn?(colorKeyUpStroke=colorBlack,colorKeyUpFill=colorWhite,colorKeyFontUp=colorBlack):!1===gameOn&&(colorKeyUpStroke=colorLight,colorKeyUpFill=colorWhite,colorKeyFontUp=colorLight)}function w(){document.location.reload()}o.addEventListener("click",()=>{n("Hire Me!",`
  <p>
...
<p>
  ...
  `,[{label:"Close",onClick:e=>{},triggerClose:!0}])}),fetch(GAMES_URL).then(e=>e.json()).then(e=>{!function(e){console.log("renderLeaderboard()");let o=e.filter(e=>null!==e.player.name),t=document.createElement("h1");t.className="title",t.innerText="Top Scores",o.sort((e,t)=>e.score<t.score?1:-1);let n=document.createElement("ol");for(let t=0;t<function(e,t){return e.length<t?e.length:t}(o,10);t++){let e=document.createElement("li");e.className="list-item";var s,a=o[t];0<o.length&&(s=a.score,a=a.player.name,e.innerText=`${s} points......${a}`),n.append(e)}const i=document.createElement("button");i.setAttribute("type","button"),i.setAttribute("id","btn-play"),i.setAttribute("class","modal--button"),i.innerHTML="Play",i.addEventListener("click",()=>function(){fetch(PLAYERS_URL,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"}}).then(e=>e.json()).then(e=>function(e){CURRENT_PLAYER=e.id,function(e){leaderboard.innerHTML="";e={player_id:e},e={method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(e)};fetch(GAMES_URL,e).then(e=>e.json()).then(e=>function(e){CURRENT_GAME=e.id,gameOn=!0,g(),r(391.995,context.currentTime,.116,"square"),r(391.995,context.currentTime+.116,.116,"square"),r(523.251,context.currentTime+.232,.232,"square"),document.body.addEventListener("keydown",e=>function(e){let t=e.code;preventDefaultKeys[t]&&e.preventDefault();let o=KEY_ARRAY.find(({code:e})=>e===t);return o.s=1,!1}(e)),document.body.addEventListener("keyup",e=>function(e){let t=e.code,o=KEY_ARRAY.find(({code:e})=>e===t);return o.s=0,!1}(e)),m(row0),m(row1),m(row2),m(row3),m(row4),interval=setInterval(u,10)}(e)).catch(e=>console.log(`createGame Failed: ${e}`))}(CURRENT_PLAYER)}(e)).catch(e=>console.log(`createPlayer: ${e}`))}());const c=document.createElement("div");c.setAttribute("class","centerWrapper"),c.append(i),leaderboard.append(t),leaderboard.append(n),leaderboard.append(c)}(e)}),r(174.614,context.currentTime,.116,"square"),r(195.998,context.currentTime+.116,.116,"square"),r(220,context.currentTime+.232,.232,"square"),ctx.width=window.innerWidth,ctx.height=window.innerHeight,m(row0),m(row1),m(row2),m(row3),m(row4),a(KEY_ARRAY),i(),c()});