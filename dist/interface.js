...
<p>-Matty</p>`,[{label:"Close",onClick:e=>{},triggerClose:!0}]));const o=document.getElementById("hireMeNav");function r(e,t,o,n){const s=context.createOscillator(),a=context.createOscillator(),i=context.createGain();s.type=n,a.type=n,i.gain.value=vol,s.connect(i),a.connect(i),i.connect(context.destination),s.frequency.value=e+1,a.frequency.value=e-2,i.gain.setValueAtTime(vol,t+o-.05),i.gain.linearRampToValueAtTime(0,t+o),s.start(t),a.start(t),s.stop(t+o),a.stop(t+o)}function l(){switch(directionV){case"north":directionV="south";break;case"south":directionV="north";break;default:return}}function d(){switch(directionH){case"east":directionH="west";break;case"west":directionH="east";break;default:return}}function n(e,t,o){console.log("showModal called, titleHtml = ",e,"contentHtml = ",t,"buttons = ",o);const n=document.createElement("div");n.classList.add("modal--"),n.innerHTML=`
    ...
    `;const t=document.createElement("button");t.setAttribute("type","button"),t.classList.add("modal--button"),t.textContent="Skip This",t.addEventListener("click",()=>g()),e.querySelector(".modal--bottom").appendChild(t);const o=document.createElement("button");o.setAttribute("type","button"),o.classList.add("modal--button"),o.textContent="Save",o.addEventListener("click",()=>{w(nameField.value.toUpperCase())}),e.querySelector(".modal--bottom").appendChild(o),document.body.appendChild(e)}():document.location.reload()))).catch(e=>console.log(`endGame: ${e}`))})()}function h(){!0===gameOn?(colorKeyUpStroke=colorBlack,colorKeyUpFill=colorWhite,colorKeyFontUp=colorBlack):!1===gameOn&&(colorKeyUpStroke=colorLight,colorKeyUpFill=colorWhite,colorKeyFontUp=colorLight)}function g(){document.location.reload()}function w(e){console.log(`savePlayer:name = ${e}`);var t={id:CURRENT_PLAYER,name:e},t={method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)};fetch(PLAYERS_URL,t).then(e=>e.json()).then(function(e){console.log(`updateGame(): name = ${e}`);e={id:CURRENT_GAME,name:e},e={method:"PATCH",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(e)};fetch(GAMES_URL,e).then(e=>e.json()).then(()=>document.location.reload()).catch(e=>console.log(`updateGame: ${e}`))}(e)).catch(e=>console.log(`savePlayer: ${e}`))}o.addEventListener("click",()=>{n("Hire Me!",`
  <p>
