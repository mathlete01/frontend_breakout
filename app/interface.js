...
const colorKeyUpStroke = colorLight;
const colorKeyUpFill = "#ffffff";
const colorKeyFontUp = colorLight;
...
const keyRowCount = 5;
const keyColumnCount = 15;
const keyPadding = 10;
const keyOffsetTop = 30;
const keyOffsetLeft = 30;
const keyWidth = w / keySegments;
